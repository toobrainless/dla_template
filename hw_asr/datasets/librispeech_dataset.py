    ...
    def _create_index(self, part):
        ...
        for flac_dir in tqdm(
            ...
            try:
                ...
                print(f"Error in {flac_dir}: {e}")
                print("continuing...")
        return index


class DataSphereLibrispeechDataset(BaseDataset):
    PATH_TO_DATASETS = Path("/home/jupyter/mnt/datasets/")
    MAPPING_PATH = {
        "dev-clean": "dev_clean",
        "dev-other": "dev_other",
    ...
    def __init__(self, part, data_dir=None, index_dir=None, *args, **kwargs):
        ...
        if data_dir is None:
            data_dir = (
                ...
                / ("librispeech_" + self.MAPPING_PATH[part])
                / ("librispeech_" + self.MAPPING_PATH[part])
                / "LibriSpeech"
            )
            # data_dir.mkdir(exist_ok=True, parents=True)
